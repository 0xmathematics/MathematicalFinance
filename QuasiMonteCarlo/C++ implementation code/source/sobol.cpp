...
//
#define _CRT_SECURE_NO_WARNINGS // for sobol localtime
# include <cstdlib>
# include <iostream>
# include <fstream>
# include <iomanip>
...
Sobol::Sobol(int Seed_, int dim_num_ ) : Seed(Seed_),dim_num(dim_num_)
{
    if (Seed ==0)
        Seed=1;
}
...
unsigned long Sobol::Max()
{
    return m-1;
}

unsigned long Sobol::Min()
{
    return 1;
}

void Sobol::getSobolSeq(float seq[]){
    i4_sobol ( dim_num, &Seed,  seq );
}
